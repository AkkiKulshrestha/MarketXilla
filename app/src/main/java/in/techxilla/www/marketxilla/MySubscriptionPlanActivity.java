                    ...
                    public void onResponse(final String response) {
                        try {
                            ...
                            for (int i = 0; i < m_jArry.length(); i++) {
                                ...
                                final TextView tv_Subscripte_till_date = (TextView) rowView1.findViewById(R.id.tv_Subscripte_till_date);
                                final TextView tv_Subscripte_on_date = (TextView) rowView1.findViewById(R.id.tv_Subscripte_on_date);
                                final TextView tv_plan_name = (TextView) rowView1.findViewById(R.id.tv_plan_name);
                                final TextView tv_plan_amount = (TextView) rowView1.findViewById(R.id.tv_plan_amount);
                                final TextView tv_status = (TextView) rowView1.findViewById(R.id.tv_status);
                                final TextView tv_status_text = (TextView) rowView1.findViewById(R.id.tv_status_text);
                                ...
                                final LinearLayout ll_header = (LinearLayout) rowView2.findViewById(R.id.ll_header);
                                final TableLayout table_layout = (TableLayout) rowView2.findViewById(R.id.table_layout);
                                final ImageView img_add = (ImageView) rowView2.findViewById(R.id.img_add);
                                ...
                                final TextView date = (TextView) rowView2.findViewById(R.id.date);
                                final TextView tv_transaction_details = (TextView) rowView2.findViewById(R.id.tv_transaction_details);
                                final TextView tv_Subscribed_till = (TextView) rowView2.findViewById(R.id.tv_Subscribed_till);
                                final TextView tv_subscribed_on = (TextView) rowView2.findViewById(R.id.tv_subscribed_on);
                                final TextView tv_planname = (TextView) rowView2.findViewById(R.id.tv_planname);
                                final TextView tv_paying_via = (TextView) rowView2.findViewById(R.id.tv_paying_via);
                                final TextView tv_amount = (TextView) rowView2.findViewById(R.id.tv_amount);
                                final TextView tv_payment_receipt = (TextView) rowView2.findViewById(R.id.tv_payment_receipt);
                                final TextView tv_Receipt_on_email = (TextView) rowView2.findViewById(R.id.tv_Receipt_on_email);
